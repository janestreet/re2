(* OASIS_START *)
(* DO NOT EDIT (digest: b9188c861df04e437444038b169c69dd) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("re2", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("re2", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "OCaml bindings for RE2";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "p\011e\161N\129\142q\229\136\155X\015\161\201\251";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
